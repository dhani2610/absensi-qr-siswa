    ...
    <main class="main">
      <div class="container">
        <section class="wrapper">
          ...
          <form name="signin" class="form" method="POST" action="{{ route('loginPost2') }}">
            @csrf
            <div class="input-control">
              <label for="email" class="input-label" hidden>Username</label>
              <input type="text" name="username" id="email" class="input-field" placeholder="Username">
            </div>
            <div class="input-control">
            ...
            <div class="input-control">
              <button class="input-submit" type="submit">Absen Siswa</button>
            </div>
          </form>
