<header id="page-topbar">
    <div class="navbar-header" style="background: #0083ff">
        <div class="d-flex">
            <!-- LOGO -->
            <div class="navbar-brand-box" style="background: white">
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('img/logo-smk2.png') }}" alt="" height="20">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('img/logo-smk2.png') }}" alt="" width="90">
                    </span>
                </a>
            </div>
        ...
        <div class="" style="background: #0083ff">
